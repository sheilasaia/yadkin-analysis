...
# ---- 4. fuction: model 1-day, low-flow freq analysis (one subbasin) ----
...
model_rch_freq_calcs=function(obs_rch_freq_calcs_df,model_p_list) {
  ...
  obs_flow_unlog=obs_rch_freq_calcs_df$obs_min_flow_cms_adj
...
baseline_model_calcs=model_rch_freq_calcs(baseline_obs_calcs,my_model_p_list)
